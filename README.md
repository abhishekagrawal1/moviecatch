# Assignment 1 - *MovieCatch*

**MovieCatch** shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
<img src='http://i.imgur.com/rXRLDr0.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
